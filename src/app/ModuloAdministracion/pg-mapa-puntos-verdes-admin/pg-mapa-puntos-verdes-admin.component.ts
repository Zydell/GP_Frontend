...
@Component({
  selector: 'app-pg-mapa-puntos-verdes-admin',
  templateUrl: './pg-mapa-puntos-verdes-admin.component.html',
  styleUrls: ['./pg-mapa-puntos-verdes-admin.component.css']
})
export class PgMapaPuntosVerdesAdminComponent {
            ...
            const contentString = `
              <div>
                ...
                <div>
                  ...
                  <p>${punto.direccion}</p>
                  <p>${punto.estado ? 'Activo' : 'Desactivado'}</p>
                </div>
              </div>`;
