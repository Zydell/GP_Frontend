...
@Component({
  selector: 'app-pg-verofertas',
  templateUrl: './pg-verofertas.component.html',
  styleUrls: ['./pg-verofertas.component.css', './../../../assets/vendor/bootstrap-icons/bootstrap-icons.css']
})
export class PgVerofertasComponent {
